...
class HelloView(APIView):
    ...
    def finalize_response(self, request, response, *args, **kwargs):
        ...
        response = createResponse(
            ...
            if success
            else status.HTTP_418_IM_A_TEAPOT,
        )
        ...
        if time_range:
            ...
            if time_range == "last_24_hours":
                ...
                if not self.request.query_params.get(
                    "start_date"
                ) or not self.request.query_params.get("end_date"):
            ...
            # Get the queryset according to the time range
            queryset = (
